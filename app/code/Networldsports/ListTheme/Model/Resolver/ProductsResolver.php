...
namespace Networldsports\ListTheme\Model\Resolver;
...
class ProductsResolver implements ResolverInterface
{
    ...
    private function getProductsData(): array
    {
        try {
            ...
            $searchCriteria = $this->searchCriteriaBuilder->addFilter('entity_id', 3,'eq')->create();
            ...
            foreach($products as $product) {
                ...
                $productRecord['allProducts'][$productId]['image'] = $product->getImage();
            }
